...
// are acive
    ...
    ADLT.SCOPE_ID = 'RandomScope'; // Put your scope here;

    ADLT.APP_ID = getParameterByName('appId'); // Put your app Id here;

    ADLT.API_KEY = getParameterByName('apiKey');;
